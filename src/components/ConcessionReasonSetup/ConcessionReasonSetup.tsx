...
import styles from './concessionReasonSetup.module.css'
import ConcessionReasonModal from "../ConcessionReasonModal/ConcessionReasonModal";

const ConcessionReasonSetup = () => {
  // API's
  const getReasonsTypesAPI = api((state) => state.getConcReason);
...
export default ConcessionReasonSetup